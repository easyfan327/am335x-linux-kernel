#define CONFIG_AM335X_JINRUI_SUPPORT
/*
 * Code for AM335X EVM.
 *
...
struct da8xx_lcdc_platform_data  LVDS_pdata = {
	.manu_name              = "JR",
	.controller_data        = &lcd_cfg,
	.type                   = "LVDS",
};
...
static struct pinmux_config lcdc_pin_mux[] = {
	...
	{"lcd_data15.lcd_data15",	OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT
						       | AM33XX_PULL_DISA},
#ifndef CONFIG_AM335X_JINRUI_SUPPORT
...
static struct pinmux_config mmc2_wl12xx_pin_mux[] = {
	...
	//{"gpmc_clk.mmc2_clk", OMAP_MUX_MODE3 | AM33XX_PIN_INPUT_PULLUP}, //2016-2-26
	{NULL, 0},
};
...
static void mmc2_wl12xx_init(int evm_id, int profile)
{
	...
	printk("setup mmc2_wl12xx_pin_mux.\n");
	am335x_mmc[1].mmc = 3;
	am335x_mmc[1].name = "wl1271";
	am335x_mmc[1].caps = MMC_CAP_4_BIT_DATA | MMC_CAP_POWER_OFF_CARD;
	am335x_mmc[1].nonremovable = true;
...
#if 1		/* conflict with norflash */
	{"gpmc_a0.gpmc_a0", OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT_PULLUP},
#endif
	{"gpmc_a1.gpmc_a1", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
	{"gpmc_a2.gpmc_a2", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
	{"gpmc_a3.gpmc_a3", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
	{"gpmc_a4.gpmc_a4", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
	{"gpmc_a5.gpmc_a5", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
	{"gpmc_a6.gpmc_a6", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
	{"gpmc_a7.gpmc_a7", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
	{"gpmc_a8.gpmc_a8", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
	{"gpmc_a9.gpmc_a9", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
	{"gpmc_a10.gpmc_a10", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
	{"gpmc_a11.gpmc_a11", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
	{"gpmc_a12.gpmc_a12", OMAP_MUX_MODE0 | AM33XX_PIN_OUTPUT_PULLUP},
...
static void fpga_init (int evm_id, int profile)
{
/*
	struct gpmc_devices_info gpmc_device[2] = {
		{ NULL, 0 },	
	...
	gpmc_device[0].pdata = (void *)1;
	gpmc_device[0].flag = GPMC_DEVICE_FPGA;
...
static void am335x_evm_setup(struct memory_accessor *mem_acc, void *context)
{
	...
	strncpy (config.name, "A335X_SK", 8);
	strcpy (config.version, "");
#endif
